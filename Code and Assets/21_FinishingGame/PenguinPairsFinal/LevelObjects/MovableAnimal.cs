...
class MovableAnimal : Animal
{
    ...
    public int AnimalIndex { get { return sprite.SheetIndex; } }
    ...
    public bool CanMoveInDirection(Point direction)
    {
        ...
        if (nextAnimal != null && nextAnimal is MovableAnimal && !IsPairWith((MovableAnimal)nextAnimal))
            return false;
    ...
    public void TryMoveInDirection(Point direction)
    {
        ...
        if (positionBeforeMoving != currentGridPosition)
        {
